...
function HybridSlider({
  ...
  return (
    <div className="mt-2 flex flex-col gap-2">
      ...
      <p className="m-0 text-center text-lg font-extrabold tracking-tight text-orange-500 tabular-nums">
              ...
              <li key={product.id} className="rounded-xl">
                ...
                >
                  ...
                  <span className="min-w-0 flex-1">
                    ...
                    <span className="mt-0.5 block text-sm font-semibold text-white/60">
                  ...
                  <span className="flex shrink-0 flex-col items-end gap-0.5">
                    ...
                    {product.totalStock > 0 ? (
                      <span className="max-w-[10rem] text-right text-xs font-bold text-orange-500">
                        {formatHybridStockLabel({
