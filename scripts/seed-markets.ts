...
const DEFAULT_SEED: FarmersMarketSeedInput[] = [
  ...
  },
  {
    ...
    latitude: 37.7955,
    longitude: -122.3937,
    operating_hours: 'Tue Thu Sat 8:00-14:00',
    season_start: 'Year-round',
    season_end: 'Year-round',
    website_url: null,
  },
  {
    name: 'Union Square Greenmarket',
    street_address: 'E 17th St & Broadway',
    city: 'New York',
    state: 'NY',
    zip_code: '10003',
    latitude: 40.7359,
    longitude: -73.9901,
    operating_hours: 'Mon Wed Fri Sat 8:00-18:00',
    season_start: 'Year-round',
    season_end: 'Year-round',
    website_url: null,
  },
  {
    ...
    street_address: '1400 Travis St',
    city: 'Houston',
    state: 'TX',
    zip_code: '77002',
    latitude: 29.753,
    longitude: -95.3662,
    operating_hours: 'Sat 8:00-13:00',
    season_start: 'March',
    season_end: 'November',
    website_url: null,
  },
  {
    ...
    street_address: '1750 N Clark St',
    city: 'Chicago',
    state: 'IL',
    zip_code: '60614',
    latitude: 41.9142,
    longitude: -87.6345,
    operating_hours: 'Wed Sat 7:00-13:00',
    season_start: 'May',
    season_end: 'October',
    website_url: null,
  },
