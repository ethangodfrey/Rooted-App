...
docs/supabase/phase32_stripe_messaging.sql   # Stripe Connect + in-app messaging foundation
...
docs/supabase/phase50_home_private_chef_vendor_types.sql # private_chef + home/private fulfillment fields
```
