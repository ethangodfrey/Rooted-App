...
|-------|---------------|------------------|
| 83a Home / Private Chef / Micro-Brand | `cursor/home-private-chef-vendor-types-428e` | SQL + fulfillment settings + vendor-types libs |
| 83b V2V connections | `cursor/vendor-to-vendor-connections-428e` | SQL + mobile VendorActions |
| 83c Mix analytics | `cursor/admin-mix-analytics-428e` | `/admin/mix-analytics` |
...
| 83f Flash promo | `cursor/low-stock-flash-promo-428e` | flash-sale libs + POS API stubs |
