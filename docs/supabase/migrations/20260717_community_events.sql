...
comment on table public.community_events is
  'Vendor/farmer hosted community events (festival, pop-up, city market, farmers market). Orange map pins.';
...
create policy "Public read active community events"
...
create policy "Hosts update own community events"
