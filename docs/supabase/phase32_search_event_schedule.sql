...
-- results. This rebuild adds hours_summary, sync_metadata, timezone, and
-- end_datetime to event metadata (all other branches unchanged from phase31).
--
...
create materialized view public.search_index as
  ...
  -- Events (publicly visible = public) — schedule fields for display dates
  select
