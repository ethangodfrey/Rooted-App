-- Vendorly Phase 50 — Vendor-to-Vendor (V2V) connections + wholesale product visibility
-- Apply after phase49.
--
...
comment on column public.products.visibility is
  'Phase 50: public (shoppers) | connected_vendors (V2V wholesale) | private (owner only).';
...
comment on table public.vendor_connections is
  'Phase 50: V2V connection requests + follow flags between vendor profiles.';
