...
export interface CreateConnectionResponse {
  ...
  authorizeUrl?: string;
  /** HTTPS URL registered with the POS provider for OAuth callback. */
  oauthRedirectUri?: string;
  /** Square only — sandbox needs a system-browser OAuth flow. */
...
export interface PosImportedLineItem {
  ...
  /** Square line type, e.g. CUSTOM_AMOUNT or ITEM */
  itemType?: string;
}
