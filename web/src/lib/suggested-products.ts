import { isTrustedMediaUrl, pickProductDisplayImage } from '@/lib/product-image';
...
export async function fetchSuggestedProducts(
  ...
  return rankSuggestedProducts((data as unknown as ProductRow[]) ?? [], interests, context).slice(0, limit);
}
