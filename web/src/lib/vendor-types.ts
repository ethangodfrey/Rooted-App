...
export function vendorTypeBadgeClass(type: VendorType | string | null | undefined): string | null {
  ...
  if (type === 'micro_brand') return MICRO_BRAND_BADGE_CLASS;
  return null;
}
...
export function vendorTypeBadgeLabel(type: VendorType | string | null | undefined): string | null {
  ...
  if (type === 'micro_brand') return 'Micro-Brand';
  return null;
}
...
export function isMicroBrandVendor(type: VendorType | string | null | undefined): boolean {
  return type === 'micro_brand';
}
