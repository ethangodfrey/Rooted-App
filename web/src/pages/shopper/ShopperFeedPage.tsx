  ...
  return (
    <div className="app-screen app-screen--titled">
      ...
      {loading ? (
        ...
        <div className="app-empty app-empty--warm">{error}</div>
        ...
        <div className="app-empty app-empty--warm">
          ...
          <p className="app-row-title" style={{ marginBottom: '0.5rem' }}>
            ...
            {mode === 'saved' ? 'No updates yet' : 'Nothing to explore'}
          ...
          <p className="app-row-meta">
            ...
            {mode === 'saved'
              ...
              ? 'Save vendors to see their postcards here, or switch to Explore.'

              : 'No posts in this area yet — check back after market days.'}
        ...
        <div className="app-list">
          ...
          {displayed.map((post) => (
            ...
            <article key={post.id} className="app-postcard">
              ...
              <p style={{ margin: '0.5rem 0', lineHeight: 1.55 }}>{post.caption}</p>
              ...
              {post.media_url ? (
                ...
                post.media_type === 'video' ? (
                  ...
                  <video
                    ...
                    style={{ width: '100%', borderRadius: 'var(--radius-lg)', marginTop: '0.75rem', maxHeight: 320 }}
